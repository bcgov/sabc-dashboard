...
class AppendixClaimRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'PostZip' => 'required:size:'.$postZipLength,
        ...
        //if the request is not using BCSC account
        if (! isset($this->assuranceLevel)) {
            $rules['question1'] = 'required';
            $rules['question2'] = 'required';
            $rules['question3'] = 'required';
            $rules['answer1'] = 'required';
            $rules['answer2'] = 'required';
            $rules['answer3'] = 'required';
        }
...
//            $input = mb_strtoupper($value);
        ...
        if ($this->gender == 'FEMALE' || $this->gender == 'WOMAN') {
            $this->gender = 'F';
        }
