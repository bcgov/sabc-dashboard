    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-7 mt-3">
                    ...
                    <div class="collapse show">
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-12">
                                    <p>A student who is enrolled in a minimum of 60 percent full course load (40 percent
                                        for students with a permanent disability, or a persistent or prolonged disability)
                                        for at least 12 consecutive weeks at a designated post-secondary school.</p>
                                            ...
                                            <div class="card-header p-2" id="headingB">
                                                <h2 class="mb-0">
                                                    <button @click="toggleCollapse('collapseB')" class="btn btn-link btn-block text-center" type="button">
                                                        Log in with a StudentAid BC User ID
                                                    </button>
                                                </h2>
                                            </div>
                ...
                <div v-if="maintenanceMode === false" class="card mb-3">
                    <div class="card-header text-dark bg-light">
                        <span class="text-primary text-left p-0">Part-Time Students</span>
                    </div>
                    <div class="collapse show">
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-12">
                                    <p>A student who is enrolled in a 20 to 59 percent of a full-time course load (20 to 39 percent
                                        for students with a permanent disability, or a persistent or prolonged disability)
                                        at a public or private designated post-secondary school.</p>
