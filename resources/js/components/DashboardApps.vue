...
<!--                        <p>Do you know you can use the BC Services Card app to log in and access StudentAid BC programs and services via the dashboard. Setting up the BC Services Card app is safe, quick, and easy.</p>-->
                        <ul class="">
                            ...
                            <li class="mb-3">To avoid potential delays in accessing your account and submitting your application, we recommend that you to <a href="https://id.gov.bc.ca/account/" target="_blank">set up the BC Services Card app</a> as soon as possible.</li>
                        </ul>
