    ...
    <div class="row">
        ...
        <div v-if="maintenanceMode === false" class="col-12">
            ...
            <template v-if="loading == false && loadingError == false">
                ...
                <form :action="'/dashboard/appendix/login/' + py + '/APPENDIX2'" method="post" id="sabc-form-builder" accept-charset="UTF-8">
                    ...
                    <div class="alert alert-contextual alert-info">
                        ...
                        <p>You are about to claim this Appendix 2 as spouse or common-law partner without a SIN.</p>
                    </div>
                    <fieldset>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            this.fetchData();
            document.title = "StudentAidBC - Appendix 2 Claim";
