    ...
    <div class="row">
        ...
        <div v-if="maintenanceMode === false" class="col-12">
            ...
            <template v-if="loading == false && loadingError == false">
                ...
                <form
                @submit="submitFom"
                :action="'/dashboard/appendix-submit-checklist/APPENDIX1/' + program_year + '/' + app_id + '/' + document_guid"
                        ...
                        <div class="form-group col-12">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="verification_confirmation">
                                    I certify that all information in my <strong>appendix 1</strong> is complete and accurate, and I understand that it is subject to verification and audit.
                                    <span class="form-required" title="This field is required.">*</span>
                                </label>
                            </div>

                            <em>You can view/print a copy of your application from your dashboard once the appendix 1 has been submitted.</em>
                        </div>
                    </div>
                </fieldset>
                        ...
                        <div class="form-group col-12">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="consent_confirmation">
                                    I will print, sign and mail the Parent Consent and Declaration page to StudentAid BC. I understand that my appendix 1 will <strong>NOT</strong> be processed unless I print, sign and mail my declaration page.
                                    <span class="form-required" title="This field is required.">*</span>
                                </label>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a :href="'/dashboard/student-loans/check-appendix1-status/' + app_id" class="btn btn-link text-left">Cancel</a>
                    </div>
                    <div class="col-md-6">
                        ...
                        <template v-else>
                            <button type="submit" class="btn btn-block btn-success">Submit my Appendix 1</button>
                        </template>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        created() {
            document.title = "StudentAidBC - Appendix 1 Submit Agreement";
        },
        mounted: function () {
            document.title = "StudentAidBC - Appendix 1 Submit Agreement";
