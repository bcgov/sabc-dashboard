<template>
    <div class="row">
        ...
        <div v-if="maintenanceMode === false" class="col-12">
            ...
            <form action="/dashboard/appendix/claim/APPENDIX1" method="post" id="sabc-form-builder" accept-charset="UTF-8">
                ...
                <div class="alert alert-contextual alert-info">
                    ...
                    <p> You are about to claim this Appendix 1 as <strong>{{fullName}}</strong>.  If this is not the right account please log out and log in as the right user before claiming this Appendix 1 access code.</p>
                </div>
                ...
                <template v-else>
                    <input type="hidden" name="appendix_type" value="APPENDIX1">
