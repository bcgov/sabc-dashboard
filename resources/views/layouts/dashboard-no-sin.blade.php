...
<div id="app">
    <header>
        <dashboard-navbar-no-sin :auth="false"></dashboard-navbar-no-sin>
    </header>

    <section class="container-fluid pt-5 mt-2 pr-3 pl-3">
        <div class="row">
    ...
    @if(session()->has('DEBUG') && env('APP_DEBUG') == true)
        <div id="debug_box" style="position: fixed; bottom: 0; left: 0; width: 100%; overflow: scroll; height: 65px; background: #eee; margin-bottom: 30px; z-index: 2;">
